          ...
          <div className='flex flex-col  lg:gap-16 gap-5'>
            <div className='flex flex-col items-center justify-center text-center gap-3'>
              <h2 className='max-w-6xl'>
                Leading Digital Bookkeeping for Nigerian Businesses with
              </h2>
              <div>
                <h2>
                  {data?.map((items:any, index:any) => (
                    <span
                      key={index}
                      className={`inline-flex m-2 py-1 px-5 rounded-full ${items.bg_color} ${items.txt_color} items-center`}>
