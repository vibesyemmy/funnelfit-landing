            ...
            <div className='flex items-center gap-1 xl:gap-4'>
              ...
              {user?.user || session?.user ? (
                ...
                <div className='flex items-center gap-2'>
                  ...
                  <Link
                    href={'/signup'}
                    className='hidden lg:block text-white px-2.5 xl:px-4 py-2 bg-purple_blue hover:bg-purple_blue/90 rounded-full transition-colors duration-200'>
                    Sign Up
                  </Link>
                </div>
              )}
              ...
              <div className='flex flex-col items-center gap-3 px-2 mt-2'>
                {user || session?.user ? (
                  ...
                  <>
                    ...
                    <Link
                      href={'/signup'}
                      className='w-full text-white px-4 py-2 bg-purple_blue hover:bg-purple_blue/90 rounded-md transition-colors duration-200'>
                      Sign Up
                    </Link>
                  </>
                )}
